  ...
  const mapBackendToFrontend = (backendData: any[]): Drama[] => {
    ...
    return backendData.map((item) => {
      ...
      return {
        ...
        year: item.year || 2024, // Fallback nếu DB không có cột year
        ...
        description: item.description || `A fascinating story about ${item.title}. Explore the genres of ${item.genres || 'drama'} featuring elite casting.`,
